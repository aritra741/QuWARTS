"""Unit tests for QuWARTS."""

import json

import pytest

from quwarts.data_layer import RecursiveCharacterSplitter, TextChunk
from quwarts.lattice_planner import LatticePlanner
from quwarts.sieve_synthesizer import SieveSynthesizer
from quwarts.extractor import ConstrainedExtractor
...
class TestEntityResolver:
    ...
    def test_union_find(self):
        ...
        from quwarts.entity_resolver import UnionFind
    ...
    def test_mention_extraction(self):
        ...
        from quwarts.entity_resolver import extract_mentions_from_records
    ...
    def test_canonical_map_application(self):
        ...
        from quwarts.entity_resolver import apply_canonical_map
...
class TestUtilities:
    ...
    def test_sql_statement_building(self):
        ...
        from quwarts.delta_engine import build_insert_statement, build_update_statement
